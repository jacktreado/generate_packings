...
int main(int argc, char *argv[]){
	...
	string Utol_str = argv[5];		// potential energy tolerance
	string seed_str = argv[6];		// seed
	string input_str = argv[7];		// file with initial atomic coordinates
	...
	Utol = N*Utol;		// potential energy tolerance
